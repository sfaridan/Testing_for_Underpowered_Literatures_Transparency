...
pval_rcts_ML_tscores   <- pval_comp(out_RCT_tscores,ML_by_tscores) #this one is in the text
...
#            ,file='pvals.txt',sep=" ")
write.table(c(", RCTS=ML (by tscores): ",pval_rcts_ML_tscores )
            ,file='pvals_RCTs_vs_ML.txt',sep=" ")