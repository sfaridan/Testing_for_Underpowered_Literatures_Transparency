...
nsims          <- c(10000)
nu             <- c(50)
dgps           <- c("null","cauchy", "realistic", "large","worst","unif","zcurve")
...
save_results(parms_normal,results_path,"_May_26_Normal")
paper_tab_normal <- write_table_like_paper(parms_normal, paste0(table_path,"Table_Sim_normal_May26"))
...
save_results(results_lognorm,results_path,"_May_26_lognormal")
paper_tab_lognormal <- write_table_like_paper(results_lognorm, paste0(table_path,"Table_Sim_log_May26"))
...
save_results(results_t,results_path,"_May_26_t")
paper_tab_lognormal <- write_table_like_paper(results_t, paste0(table_path,"Table_Sim_t_May26"))
